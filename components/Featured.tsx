  ...
  return (
    <div className="mt-6 mb-6 md:mt-10 md:mb-10 bg-[#FCFCFE] rounded-xl group flex flex-col md:flex-row cursor-pointer">
      <div className="w-full h-[450px]">
        <Image src={FeaturedImg} alt="featured Image" className="rounded-t-xl md:rounded-l-xl md:rounded-tr-none object-cover object-center h-[450px]"/>
      </div>
        ...
        <div className="flex-grow">
          <Button
            ...
            className="mr-2 mb-2 rounded-full border border-gray-600 hover:bg-transparent
             text-gray-600 hover:text-gray-600 cursor-default"
          >
            Web Development
          </Button>
        </div>
